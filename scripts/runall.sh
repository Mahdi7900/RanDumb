...
python main.py --embed --embed_dim 1000 --model NsCE --dataset mnist
python main.py --embed --embed_dim 1000 --model NsCE --dataset cifar10
python main.py --embed --embed_dim 1000 --model NsCE --dataset cifar100
python main.py --embed --embed_dim 1000 --augment --model NsCE --dataset cifar10
python main.py --embed --embed_dim 1000 --augment --model NsCE --dataset cifar100
...
python main.py --embed --embed_dim 2000 --model NsCE --dataset mnist
python main.py --embed --embed_dim 2000 --model NsCE --dataset cifar10
python main.py --embed --embed_dim 2000 --model NsCE --dataset cifar100
python main.py --embed --embed_dim 2000 --augment --model NsCE --dataset cifar10
python main.py --embed --embed_dim 2000 --augment --model NsCE --dataset cifar100